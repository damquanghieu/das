...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link " data-toggle="modal" data-target="#modal-sm-reg">
                        ...
                        <div class="row" name="edit-password">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" required name="oldpassword" class="form-control"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" required name="newpassword" class="form-control"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="confirmnewpassword" class="col-sm-5 col-form-label">Xác nhận mật khẩu
                                        mới</label>
                                    <div class="col-sm-7">
                                        <input type="text" required name="confirmnewpassword" class="form-control"
                                            id="confirmnewpassword" placeholder="Nhập lại mật khẩu mới" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" name="edit-password">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" required name="fullnamereg" class="form-control"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="username" class="col-sm-5 col-form-label">Tài khoản</label>
                                    <div class="col-sm-7">
                                        <input type="text" required name="usernamereg" class="form-control"
                                            placeholder="Nhập tài khoản cũ" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" required name="passwordreg" class="form-control"
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="confirmnewpassword" class="col-sm-5 col-form-label">Xác nhận mật khẩu
                                        mới</label>
                                    <div class="col-sm-7">
                                        <input type="text" required name="confirmpasswordreg" class="form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="admin" value="10"
                                                name="permission">
                                            <label for="admin" class="custom-control-label">Admin</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="user" value="1"
                                                name="permission">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="JP11" value="JP"
                                                name="address">
                                            <label for="JP11" class="custom-control-label">JP</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="US11" value="US"
                                                name="address">
                                            <label for="US11" class="custom-control-label">US</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="GER11" value="GER"
                                                name="address">
                                            <label for="GER11" class="custom-control-label">GER</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $("form[name=register]").submit(function(e) {
        ...
        if ($('input[name=fullnamereg]').val() == ''){
            ...
            $('input[name=fullnamereg]').removeClass('is-invalid');
            $('input[name=fullnamereg]').addClass('is-valid');
            checkfullname = 1;
        }
        if ($('input[name=usernamereg]').val() == ''){
            $('input[name=usernamereg]').addClass('is-invalid');
            checkuser=0;
        }else {
            $('input[name=usernamereg]').removeClass('is-invalid');
            $('input[name=usernamereg]').addClass('is-valid');
            checkuser = 1;
        }
        if ($('input[name=passwordreg]').val() == ''){
            $('input[name=passwordreg]').addClass('is-invalid');
            checkold=0;
        }else {
            $('input[name=passwordreg]').removeClass('is-invalid');
            $('input[name=passwordreg]').addClass('is-valid');
            checkold = 1;
        }
        if ($('input[name=confirmpasswordreg]').val() == ''){
            $('input[name=confirmpasswordreg]').addClass('is-invalid');
            checkconfirm = 0;
        }else if($('input[name=confirmpasswordreg]').val() != $('input[name=passwordreg]').val()){
            $('input[name=confirmpasswordreg]').addClass('is-invalid');
            checkconfirm = 0;
        }else if ($('input[name=confirmpasswordreg]').val() == $('input[name=passwordreg]').val()) {
            $('input[name=confirmpasswordreg]').removeClass('is-invalid');
            $('input[name=confirmpasswordreg]').addClass('is-valid');
            checkconfirm = 1;
        }
        if (checkconfirm == 1 && checkuser == 1 && checkold == 1){
